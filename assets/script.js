...
(function(){
  ...
  "Natječaji i dokumentacija za zakup poljoprivrednog zemljišta.": "Tenders and documentation for leasing agricultural land.",
  ...
  "Od paušalnih obrta, udruga i poduzeća do savjetovanja i natječajne dokumentacije — sve je organizirano jasno, uredno, profesionalno i dostupno kroz digitalnu suradnju.": "From flat-rate sole proprietors, associations and companies to consulting and tender documentation — everything is organized clearly, professionally and available through digital cooperation.",
  ...
  "Knjigovodstvo za paušalne obrte, PDV obrte i poduzeća, poslovno savjetovanje i natječajna dokumentacija.": "Bookkeeping for flat-rate sole proprietors, VAT-registered sole proprietors and companies, business consulting and tender documentation.",
  ...
  "aktivnih usluga": "active services",
  "valuta": "currency",
  "formati": "formats",
  "Tablični format": "Tabular format",
  "CSV cjenik": "CSV price list",
  "Preuzmi CSV cjenik": "Download CSV price list",
  "Preuzmi .csv datoteku": "Download .csv file",
  "Strukturirani format": "Structured format",
  "XML cjenik": "XML price list",
  "Preuzmi XML cjenik": "Download XML price list",
  "Otvori .xml datoteku": "Open .xml file",
  ...
  "Knjigovodstvena podrška, dokumentacija i savjetovanje za uredno poslovanje.": "Bookkeeping support, documentation and consulting for well-organized business operations.",
